...
#ifndef _GSG_TOOLS_VISITORS_CALLBACKS_MODIFY_VISITOR_CLASS_H_
#define _GSG_TOOLS_VISITORS_CALLBACKS_MODIFY_VISITOR_CLASS_H_
...
class GSG_TOOLS_EXPORT Modify : public GSG::Scene::Visitors::Visitor
{
public:
...
#endif // _GSG_TOOLS_VISITORS_CALLBACKS_MODIFY_VISITOR_CLASS_H_
